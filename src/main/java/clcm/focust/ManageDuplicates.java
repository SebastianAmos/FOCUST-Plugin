...
public class ManageDuplicates {
	...
	/**
	 * converts original label value to 1 then imposes the values from the "labels" ImagePlus by multiplication.
	 * 
	 * @param labels Imp with labels to impose on the orignal image. i.e. secondary objects.
	 * @param original Imp with labels that need to adopt the labelling from the "labels" imp. i.e. primary objects.
	 * @return
	 */
	...
	/**
	 * Compare the labels of two images and store in a map.
	 * keys = original labels and values = relabelled labels (potentially duplicates)
	 * @param original
	 * @param relabelled
