...
public class Segment {
	...
	public static void Spheroid() {
		...
		// Define macro code to execute on clicking "run analysis"
		String spheroidMacro = 
					  "/* ==============================\r\n"
					...
					+ "print(\"Selecting CLIJ2\");\r\n"
					+ "run(\"CLIJ2 Macro Extensions\", \"cl_device=\");\r\n"
					+ "Ext.CLIJ2_clear();\r\n"
					+ "print(\"CLIJ2 actived successfully\");\r\n"
					+ "\r\n"
		...
		try {
			interp.runBatchMacro(spheroidMacro, null);
		} catch (Throwable e) {
			interp.abortMacro();
