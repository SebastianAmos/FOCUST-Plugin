...
public class SingleCellView extends JFrame {
    ...
    private final JPanel paneSingleCell;
    private final JTextField txtbInputDir;
    ...
    private final JTextField txtSecDMx;
    private final JTextField txtSecDMy;
    private final JTextField txtSecDMz;
    private final JTextField txtSecThreshold;
    private final JTextField txtOutputDir;
    private final JTextField txtSingleCellChannel3Name;
    private final JTextField txtSingleCellChannel4Name;
    private final JTextField txtSingleCellGrouping;
    ...
    public SingleCellView() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(SingleCellView.class.getResource("/icon2.png")));
        ...
        cbChannelTotal.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
				...
				txtSingleCellChannel4Name.setEnabled(cbChannelTotal.getSelectedItem().toString().equals("4"));
                ...
                } else txtSingleCellChannel3Name.setEnabled(cbChannelTotal.getSelectedItem().toString().equals("4"));
            }
        });
